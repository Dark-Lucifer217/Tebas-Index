...
echo $yellow
figlet -f future "BlackHat Cyber Indonesia"
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo
echo $indigo"	~"$cyan"{"$white"A"$cyan"}"$green"."$yellow"Tebas Index"$cyan
echo $indigo"        ~"$cyan"{"$white"B"$cyan"}"$green"."$yellow"Scan Website"$cyan
...
echo $indigo"=============================================================="
echo
echo $white "╭─"$yellow"MiSetya"$cyan" ~/LCI"$white
read -p " ╰─$ "  apaan
echo
if [ $apaan = "A" ] || [ $apaan = "a" ]
then
...
read -p " ╰─$ "  target
echo
echo $red "Masukan Script nya cok!!! "
echo $green "╭─"$blue"MiSetya"$cyan" ~/Nama SC Harus (index.html) ganti dulu sana"$white
read -p " ╰─$ "  script
...
echo $cyan "Deface Massal Sebanyak 20 Website"
echo
...
echo
echo "Masukan Script !!!!"
echo $white "╭─"$green"MiSetya"$cyan" ~/LCI"$white                               
read -p " ╰─$ " script
echo
echo
...
echo $white "╭─"$green"MiSetya"$cyan" ~/Crot"$white
read -p " ╰─$ " target3
...
if [ $apaan = "Q" ] || [ $apaan = "q" ]
then
echo " Terimakasih Sudah Menggunakan Tools Ini ya coeg :) "
exit
clear
fi
